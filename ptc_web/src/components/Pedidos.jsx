...
import { query, doc, where, setDoc, getDocs, getFirestore, collection } from "firebase/firestore";
                    ...
                    <Table id="tablaProductos" striped bordered hover className="tablaProductos numpedi table table-bordered border border-secondary">
                        <thead className="headersTAble">
                            <tr id="topOfDataPedido">
                                ...
                                <th colSpan={2} ><select id="select2" onChange={SeSeleccionoTarima} name="proveedores">
                                ...
                                <th>Demanda</th>
                                <th ><input className="inputEditar" onChange={onChangeCantidad} required type="number" min={1} max={100000} /></th>
                                <th colSpan={2}>
